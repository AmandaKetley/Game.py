...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.image_run = [pygame.image.load("imagens/run0001.png").convert_alpha(),
                          pygame.image.load("imagens/run0002.png").convert_alpha(),
                          pygame.image.load("imagens/run0003.png").convert_alpha(),
                          pygame.image.load("imagens/run0004.png").convert_alpha(),
                          pygame.image.load("imagens/run0005.png").convert_alpha(),
                          pygame.image.load("imagens/run0006.png").convert_alpha(),
                          pygame.image.load("imagens/run0007.png").convert_alpha(),
                          pygame.image.load("imagens/run0008.png").convert_alpha(),
                          ]
        self.image_fall = pygame.image.load("imagens/run0004.png").convert_alpha()
        self.image = pygame.image.load("imagens/run0001.png").convert_alpha()
    ...
    def update(self, *args):
        ...
        def fly(self):
            ...
            if key[pygame.K_SPACE]:
                self.rect[1] -= 30
                self.image = pygame.image.load("imagens/run0006.png").convert_alpha()
                self.image = pygame.transform.scale(self.image, [100, 100])
...
class Ground(pygame.sprite.Sprite):
    def __init__(self, xpos):
        pygame.sprite.Sprite.__init__(self)
        self.image = pygame.image.load("imagens/chao.jpg").convert_alpha()
...
class Obstacles(pygame.sprite.Sprite):
    def __init__(self, xpos, ysize):
        pygame.sprite.Sprite.__init__(self)
        self.image = pygame.image.load('imagens/Box.png').convert_alpha()
        self.image = pygame.transform.scale(self.image, [100, 100])
        self.rect = pygame.Rect(100, 100, 100, 100)
        self.rect[0] = xpos
        self.mask = pygame.mask.from_surface(self.image)
...
class Coins(pygame.sprite.Sprite):
    def __init__(self, xpos, ysize):
        pygame.sprite.Sprite.__init__(self)
        self.image = pygame.image.load('imagens/coin.png').convert_alpha()
...
BACKGROUND = pygame.image.load("imagens/back1.jpg").convert_alpha()
